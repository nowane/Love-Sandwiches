...
def update_worksheet(data, worksheet):
    """
    Revieces a list of integers to be inserted into a worksheet.
    Update the relevant worksheet with the provided data.
    """
...
def calculate_stock_data(data):
    """
    Calculate the average stockm for each item type, adding 10%
    """
